...
class ParticleFilter(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        # If all Ghosts in Jail
        # all jail position must be 1
        if noisyDistance == None:
    ...
    def elapseTime(self, gameState):
        ...
        # same as in previous question, but considering particles instead of beliefs
        # newParticles = util.Counter();
        # for oldPos in self.legalPositions:
        #     newPosDist = self.getPositionDistribution(self.setGhostPosition(gameState, oldPos))
        #     for p in newPosDist:
        #         newParticles[p] += self.particles[oldPos]*newPosDist[p]
        #
        # newParticles.normalize();
        # self.beliefs=newParticles


        # getting an error for Q5 "list indices must be integers, not tuple"
...
class JointParticleFilter:
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            # haven't used self.ghostAgents[ghostIndex-1]...
